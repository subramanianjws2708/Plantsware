...
use App\Http\Controllers\Frontend\UserDashboardController; // <-- Import the controller
...
Route::prefix('checkout')->name('checkout.')->controller(CheckoutController::class)->group(function () {
    ...
    // The confirmation route used in the controller:
    Route::get('/order/{order}/confirmation', 'confirmation')->name('order.confirmation');
});

// Auth Routes (fixed as per instructions)
