...
Route::post('/cart/add/{product}', [FrontendProductController::class, 'addToCart'])->name('cart.add');
Route::delete('/cart/remove/{id}', [FrontendProductController::class, 'removeFromCart'])->name('cart.remove');
Route::post('/checkout', [FrontendProductController::class, 'checkout'])->name('checkout');
// Static pages
