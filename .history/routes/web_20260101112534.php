...
Route::controller(CartController::class)->group(function () {
    ...
    Route::get('/wishlist/{product}', [CartController::class, 'addToWishlist'])->name('wishlist.add');
    Route::delete('/wishlist/{product}', [CartController::class, 'removeFromWishlist'])->name('wishlist.remove');
});
// Static pages
