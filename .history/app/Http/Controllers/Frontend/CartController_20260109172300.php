...
class CartController extends Controller
{
     ...
     */
    public function update(Request $request, $id)  // Changed from Cart $cartItem to $id
{
    // Find the cart item
    ...
    \Log::info('Cart Update Request:', [
        'item_id' => $id,
        'cart_item_found' => $cartItem ? 'Yes' : 'No',
        'quantity' => $request->input('quantity'),
        'is_ajax' => $request->ajax(),
        'user' => auth()->id(),
    ]);
    
    // Authorize the cart item
     ...
     */
    public function remove(Request $request, $id)  // Changed from Cart $cartItem to $id
    {
        // Find the cart item
        $cartItem = Cart::findOrFail($id);
