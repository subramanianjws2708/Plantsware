...
class SubcategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.products-management.subcategories')->with('success', 'Subcategory created successfully');
    }
    ...
    public function update(Request $request, Subcategory $subcategory)
    {
        ...
        return redirect()->route('admin.products-management.subcategories', $validated['category_id'])
    ...
    public function destroy(Subcategory $subcategory)
    {
        ...
        $subcategory->delete();
        return redirect()->route('admin.products-management.subcategories')->with('success', 'Subcategory deleted successfully');
    }
}
