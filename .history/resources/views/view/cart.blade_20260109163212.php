...
// In your cart.blade.php, add this test function at the end
...
document.querySelectorAll('.increment').forEach(btn => {
    console.log('Increment button found:', btn);
});

// Simple test function
window.testCart = function() {
    alert('JavaScript is working!');
    console.log('Cart functions are available');
};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const testBtn = document.querySelector('.increment');
    if (testBtn) {
