...
<body>
    ...
    <!-- header area -->
    <header>
        <div class="topbar-outer py-2 d-none d-lg-block">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 topbar_left">
                        ...
                        <div class="text-left header-top-left pt-2">
                            <a href="{{ url('/') }}">
                                <img src="{{ asset('assets/images/logo-1.png') }}"
                                    class="img-responsive img" alt="logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-xl-9 col-lg-9 col-6 head-search">
                        <div class="d-flex navbar">
                            ...
                            <div class="input-class text-left col-12 col-md-12 col-lg-7 order-2 order-lg-1">
                                <form class="between-header border border-danger rounded mb-0 head-left w-100" action="{{ url('search') }}" method="GET" role="search">
                                    <div class="d-flex align-items-stretch w-100 gap-0">
                                        <input type="text" name="q" placeholder="Search Products" class="form-control flex-grow-1" aria-label="search" aria-describedby="button-addon2">
                                        <button type="submit" class="btn btn-danger text-uppercase font-weight-normal flex-shrink-0" id="button-addon2">
                                            Search
                                        </button>
                                    </div>
                                </form>
                            ...
                            <div class="col-xl-5 col-lg-5 head-right text-right order-1 order-lg-2">
                                <ul class="top_cart mb-0 p-0 list-unstyled d-flex justify-content-end gap-3">
                                    ...
                                    <li class="dropdown right1 md_acc md_acco">
                                        ...
                                        <span class="dropdown-toggle my_account" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            My account
                                        </span>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <button class="navbar-toggler d-lg-none d-md-block d-sm-block" type="button" id="menuToggle" aria-label="Toggle menu">
                            <span class="navbar-toggler-icon">☰</span>
                        </button>

                        <ul class="main-menu navbar mb-0 p-0">
                            <li>
                                <button class="close-menu" id="closeMenu" type="button" aria-label="Close menu">×</button>
                            </li>
                            <!-- Home -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleStickyNav() {
        ...
        if (scrollTop > 100) {
            headerBottom && headerBottom.classList.add('sticky-nav');
            ...
            headerBottom && headerBottom.classList.remove('sticky-nav');
