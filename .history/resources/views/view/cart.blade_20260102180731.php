                                                ...
                                                <form action="{{ route('cart.update', $item) }}" method="POST" class="d-inline me-3">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                                            onclick="let input = this.parentNode.querySelector('input'); if(input.value > 1){ input.stepDown(); this.form.submit(); }">−</button>
                ...
                <div class="col-lg-4">
                    <div class="summary-card p-4 border rounded bg-light">
                        ...
                        <div class="summary-row d-flex justify-content-between">
                            <span>Subtotal:</span>
                            <span class="summary-amount">₹{{ number_format($subtotal ?? 0, 0) }}</span>
                        </div>
                        <div class="summary-row d-flex justify-content-between">
                            <span>Shipping:</span>
