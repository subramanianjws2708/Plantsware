                ...
                <div class="side-menu bg-white rounded shadow-sm p-3 sticky-top" style="top: 20px; z-index: 1; border: 1px solid #ddd;">
                    ...
                    <div class="filter-section active mb-3">
                        <h3 class="filter-title d-flex justify-content-between align-items-center mb-2">
                            Price Range
                            <span class="price-range-value">₹0 - ₹5000</span>
                        </h3>
                        <div class="filter-options">
                            <input type="range" class="form-range" min="0" max="10000" step="100" id="price-max" value="5000" style="width: 100%;">
                        </div>
                    </div>
                    ...
                    <div class="filter-section active mb-3">
                        ...
                        <div class="filter-options">
                            <div class="filter-item">
                                <input type="radio" name="discount" id="discount-all" class="filter-radio" checked>
                            ...
                            <div class="filter-item">
                                <input type="radio" name="discount" id="discount-50" class="filter-radio">
                            ...
                            <div class="filter-item">
                                <input type="radio" name="discount" id="discount-30" class="filter-radio">
                            ...
                            <div class="filter-item">
                                <input type="radio" name="discount" id="discount-10" class="filter-radio">
                            ...
                            <div class="filter-item">
                                <input type="radio" name="discount" id="discount-below10" class="filter-radio">
                    ...
                    <div class="filter-section active mb-3">
                        ...
                        <div class="filter-options">
                            <div class="filter-item">
                                <input type="checkbox" id="weight-100g" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="weight-500g" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="weight-1kg" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="weight-5kg" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="weight-above5kg" class="filter-checkbox">
                    ...
                    <div class="filter-section active mb-3">
                        ...
                        <div class="filter-options">
                            <div class="filter-item">
                                <input type="checkbox" id="brand-organic" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="brand-garden" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="brand-green" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="brand-natural" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="brand-premium" class="filter-checkbox">
                    ...
                    <div class="filter-section active mb-3">
                        ...
                        <div class="filter-options">
                            <div class="filter-item">
                                <input type="radio" name="rating" id="rating-4" class="filter-radio">
                            ...
                            <div class="filter-item">
                                <input type="radio" name="rating" id="rating-3" class="filter-radio">
                            ...
                            <div class="filter-item">
                                <input type="radio" name="rating" id="rating-2" class="filter-radio">
                    ...
                    <div class="filter-section active mb-3">
                        ...
                        <div class="filter-options">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="fast-delivery" class="filter-checkbox">
                    ...
                    <div class="filter-section active mb-3">
                        ...
                        <div class="filter-options">
                            <div class="filter-item">
                                <input type="radio" name="sort" id="sort-popular" class="filter-radio" checked>
                                <label for="sort-popular" class="filter-label">Popularity</label>
                            </div>
                            <div class="filter-item">
                                <input type="radio" name="sort" id="sort-price-low" class="filter-radio">
                                <label for="sort-price-low" class="filter-label">Price: Low to High</label>
                            </div>
                            <div class="filter-item">
                                <input type="radio" name="sort" id="sort-price-high" class="filter-radio">
                                <label for="sort-price-high" class="filter-label">Price: High to Low</label>
                            </div>
                            <div class="filter-item">
                                <input type="radio" name="sort" id="sort-new" class="filter-radio">
                                <label for="sort-new" class="filter-label">Newest First</label>
                            </div>
                            <div class="filter-item">
                                <input type="radio" name="sort" id="sort-discount" class="filter-radio">
                                <label for="sort-discount" class="filter-label">Discount</label>
                            </div>
                            <div class="filter-item">
                                <input type="radio" name="sort" id="sort-rating" class="filter-radio">
                    ...
                    <div class="filter-section active mb-3">
                        ...
                        <div class="filter-options">
                            <div class="filter-item">
                                <input type="checkbox" id="value-best" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="value-premium" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="value-budget" class="filter-checkbox">
                    ...
                    <div class="filter-section active mb-3">
                        ...
                        <div class="filter-options">
                            <div class="filter-item">
                                <input type="checkbox" id="delivery-free" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="delivery-same-day" class="filter-checkbox">
                            ...
                            <div class="filter-item">
                                <input type="checkbox" id="delivery-next-day" class="filter-checkbox">
                    ...
                    <div class="filter-actions d-flex gap-2 mt-3">
                        <button class="btn-filter btn-apply flex-fill" id="apply-filters">Apply Filters</button>
                        <button class="btn-filter btn-reset flex-fill" id="reset-filters">Reset All</button>
                    </div>
                ...
                <div class="products-area">
                    <div class="products-header bg-white rounded p-3 mb-4">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                            <h2 class="category-name mb-2 mb-md-0">Garden Products</h2>
