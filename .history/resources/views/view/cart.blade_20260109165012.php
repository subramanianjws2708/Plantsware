...
<!-- Ensure CSRF token is present in header -->
        ...
        <div class="row">
            <div class="col-12">
                <ul class="list-unstyled mb-0">
                    ...
                    <li class="d-inline-block font-weight-bolder">
                        <span class="text-decoration-none text-dark">Cart</span>
                    </li>
                </ul>
            </div>
        </div>
...
function updateCartItem(itemId, change) {
    ...
    .then(data => {
        if (data.success) {
            ...
            const itemTotal = document.getElementById(`itemTotal_${itemId}`);
...
document.addEventListener('DOMContentLoaded', function() {
    // Could add any JS initialization here if needed.
});
</script>
