{{-- 
    NOTE FOR DEVELOPERS:
    The error "Namespace declaration statement has to be the very first statement or after any declare call in the script" is a PHP error.
    Blade templates should NOT have any namespace or PHP 'use' statements outside of @php blocks,
    and the @php block should appear before any HTML or includes.
    The below code correctly places the `use` statement at the very top, wrapped in a @php block. 
--}}
    ...
    <div class="container-fluid px-4">
        ...
        <div class="swiper product-swiper">
            <div class="swiper-wrapper">
                ...
                <!-- only "New Arrivals" section add-to-cart made functional as requested ... -->
            </div>
            <div class="swiper-button-next"></div>
            <div class="swiper-button-prev"></div>
        </div>
...
<!-- Rest of file unchanged (testimonials, blogs, footer, etc.) -->
@include('view.layout.footer')

<!-- OPTIONAL: Show notification after Add to Cart (optional JS) -->
<script>
