...
.image-slider .swiper-slide {
    ...
    .image-slider:hover .slide-image {
    ...
    /* Navigation for inner slider - FIXED */
    .inner-navigation {
        position: absolute;
        top: 50%;
    ...
    .product-image-container:hover .inner-navigation {
        opacity: 1;
    }
...
<div class="container">
    ...
    <div class="product-swiper swiper">
        <div class="swiper-wrapper">
                ...
                <div class="product-card">
                    <div class="product-image-container">
                        <div class="image-slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img1.jpg" alt="Aquarium Plant 1" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img2.jpg" alt="Aquarium Plant 2" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img3.jpg" alt="Aquarium Plant 3" class="slide-image">
                                </div>
                            </div>
                            <div class="inner-navigation">
                                <button class="inner-nav-btn prev-btn"><i class="fas fa-chevron-left"></i></button>
                                <button class="inner-nav-btn next-btn"><i class="fas fa-chevron-right"></i></button>
                            </div>
                        </div>
                        <span class="discount-badge">10% OFF</span>
                    </div>
                    <div class="product-info">
                        <h3 class="product-title">Anubias Plant</h3>
                ...
                <div class="product-card">
                    <div class="product-image-container">
                        <div class="image-slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img2.jpg" alt="Java Fern 1" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img3.jpg" alt="Java Fern 2" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img1.jpg" alt="Java Fern 3" class="slide-image">
                                </div>
                            </div>
                            <div class="inner-navigation">
                                <button class="inner-nav-btn prev-btn"><i class="fas fa-chevron-left"></i></button>
                ...
                <div class="product-card">
                    <div class="product-image-container">
                        <div class="image-slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img3.jpg" alt="Amazon Sword 1" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img2.jpg" alt="Amazon Sword 2" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img1.jpg" alt="Amazon Sword 3" class="slide-image">
                                </div>
                            </div>
                            <div class="inner-navigation">
                                <button class="inner-nav-btn prev-btn"><i class="fas fa-chevron-left"></i></button>
                    ...
                    <div class="product-info">
                        <h3 class="product-title">Amazon Sword</h3>
                        <div class="product-price">
                ...
                <div class="product-card">
                    <div class="product-image-container">
                        <div class="image-slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img1.jpg" alt="Cryptocoryne 1" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img2.jpg" alt="Cryptocoryne 2" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img3.jpg" alt="Cryptocoryne 3" class="slide-image">
                                </div>
                            </div>
                            <div class="inner-navigation">
                                <button class="inner-nav-btn prev-btn"><i class="fas fa-chevron-left"></i></button>
                    ...
                    <div class="product-info">
                        <h3 class="product-title">Cryptocoryne</h3>
                        <div class="product-price">
                ...
                <div class="product-card">
                    <div class="product-image-container">
                        <div class="image-slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img2.jpg" alt="Water Wisteria 1" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img3.jpg" alt="Water Wisteria 2" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img1.jpg" alt="Water Wisteria 3" class="slide-image">
                                </div>
                            </div>
                            <div class="inner-navigation">
                                <button class="inner-nav-btn prev-btn"><i class="fas fa-chevron-left"></i></button>
                    ...
                    <div class="product-info">
                        <h3 class="product-title">Water Wisteria</h3>
                        <div class="product-price">
            ...
            <!-- Product 6 (Additional for looping) -->
            <div class="swiper-slide">
                <div class="product-card">
                    <div class="product-image-container">
                        <div class="image-slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img3.jpg" alt="Hornwort 1" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img2.jpg" alt="Hornwort 2" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img1.jpg" alt="Hornwort 3" class="slide-image">
                                </div>
                            </div>
                            <div class="inner-navigation">
                                <button class="inner-nav-btn prev-btn"><i class="fas fa-chevron-left"></i></button>
                    ...
                    <div class="product-info">
                        <h3 class="product-title">Hornwort</h3>
                        <div class="product-price">
            ...
            <!-- Product 7 (Additional for looping) -->
            <div class="swiper-slide">
                <div class="product-card">
                    <div class="product-image-container">
                        <div class="image-slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img1.jpg" alt="Dwarf Hairgrass 1" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img2.jpg" alt="Dwarf Hairgrass 2" class="slide-image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://whatelse.in/plantsware1/public/assets/images/images/img3.jpg" alt="Dwarf Hairgrass 3" class="slide-image">
                                </div>
                            </div>
                            <div class="inner-navigation">
                                <button class="inner-nav-btn prev-btn"><i class="fas fa-chevron-left"></i></button>
                    ...
                    <div class="product-info">
                        <h3 class="product-title">Dwarf Hairgrass</h3>
                        <div class="product-price">
        ...
        <!-- Navigation buttons for outer carousel -->
        <div class="swiper-button-next"></div>
        <div class="swiper-button-prev"></div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Initialize outer product carousel with proper loop settings
        const productSwiper = new Swiper('.product-swiper', {
            slidesPerView: 1,
            spaceBetween: 25,
            loop: true,
            loopedSlides: 5, // Add this for better loop behavior
            speed: 600,
            autoplay: {
                delay: 5000,
            ...
            on: {
                ...
                beforeInit: function() {
                    const originalSlides = Array.from(this.wrapperEl.children);
                    
                    // Add duplicate slides for better loop effect
        ...
        // Initialize inner image sliders for each product
        document.querySelectorAll('.image-slider.swiper').forEach((sliderContainer, index) => {
            // Check if already initialized
            if (sliderContainer.swiper) return;
            
            // Find the navigation buttons within this specific slider
            const nextBtn = sliderContainer.querySelector('.next-btn');
            const prevBtn = sliderContainer.querySelector('.prev-btn');
            
            if (!nextBtn || !prevBtn) {
                console.error('Navigation buttons not found for slider', sliderContainer);
                return;
            }
            ...
            const swiperInstance = new Swiper(sliderContainer, {
                ...
                loopAdditionalSlides: 2, // Better loop behavior
            });
            
            // Pause autoplay on hover
            const parentContainer = sliderContainer.closest('.product-image-container');
            if (parentContainer) {
        ...
        document.querySelectorAll('.btn-primary').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                console.log(`Buying: ${productTitle}`);
