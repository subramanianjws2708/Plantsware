                                ...
                                <div class="item-details">
                                    ...
                                    <div class="quantity-controls">
                                        ...
                                        <div class="qty-input-group">
                                            ...
                                            <button type="button" class="qty-btn increment" data-item-id="{{ $item->id }}" type="button">+</button>
                                        </div>
                                    </div>
                                    <div class="item-actions">
                                        @if(Auth::check())
                                            @if(Auth::user()->inWishlist($item->product))
                                                <button type="button" class="action-btn remove-wishlist" data-product-id="{{ $item->product->id }}" type="button">
                                                    <i class="fas fa-heart text-danger"></i> Remove from Wishlist
                                                </button>
                                            @else
                                                <button type="button" class="action-btn add-wishlist" data-product-id="{{ $item->product->id }}" type="button">
                                        ...
                                        <button type="button" class="action-btn remove remove-cart" data-item-id="{{ $item->id }}" type="button">
