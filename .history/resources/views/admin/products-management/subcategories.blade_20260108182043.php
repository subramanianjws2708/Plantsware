{{-- resources/views/admin/subcategories.blade.php --}}
...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <form action="{{ route('admin.categories.subcategories', $category) }}" method="GET">
            ...
            <div class="col-md-6 text-end">
                <form action="{{ route('admin.categories.subcategories', $category) }}" method="GET" class="d-inline">
            ...
            <table class="table table-striped table-hover">
                <thead class="table-light">
                    <tr>
                        <th>Image</th>
                        <th>
                            <a href="{{ route('admin.categories.subcategories', [$category] + request()->query()->except('page') + ['sort' => 'name', 'direction' => request('sort') == 'name' && request('direction') == 'asc' ? 'desc' : 'asc']) }}" class="text-dark text-decoration-none">
                                Name
                        ...
                        <th>
                            <a href="{{ route('admin.categories.subcategories', [$category] + request()->query()->except('page') + ['sort' => 'sort_order', 'direction' => request('sort') == 'sort_order' && request('direction') == 'asc' ? 'desc' : 'asc']) }}" class="text-dark text-decoration-none">
                                Sort Order
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            @if($subcategory->image)
                                <img src="{{ asset('storage/' . $subcategory->image) }}" style="width: 60px; height: 60px; object-fit: cover; border-radius: 8px;">
                            @else
                    ...
                    <tr>
                        <td colspan="4" class="text-center py-4">
                            ...
                            <a href="{{ route('admin.categories.subcategories.create', ['category' => $category->id]) }}">Add one now</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
