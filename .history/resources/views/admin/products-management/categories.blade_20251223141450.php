            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{-- The route was previously 'admin.products-management.subcategories', which does not exist.
                                 Use the correct route for category subcategories listing. --}}
                            <a href="{{ route('admin.products-management.subcategories', $category) }}" class="btn btn-sm btn-outline-primary">
