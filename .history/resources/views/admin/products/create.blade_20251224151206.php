                            ...
                            <div class="mb-3">
                                ...
                                <div id="size-checkboxes">
                                    ...
                                    @php
                                        ...
                                        $circularSizes = ['6x6 inch', '8x8 inch', '10x10 inch', '12x12 inch', '15x15 inch'];
                                        $rectangularSizes = ['5 Gallon', '7 Gallon', '10 Gallon', '12 Gallon', '15 Gallon'];
                                    @endphp

                                <label for="size" class="form-label">Size</label>
                                <input type="text" class="form-control" id="size" name="size" value="{{ old('size') }}" placeholder="e.g., 12x12 inch or 10 Gallon">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="shape" name="shape">
                                    ...
                                    <option value="Circular" {{ old('shape') == 'Circular' ? 'selected' : '' }}>Circular</option>
