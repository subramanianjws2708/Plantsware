                        ...
                        <tr class="align-middle text-center">
                            ...
                            <td class="text-end pe-3">
                                ...
                                <div class="text-muted small">
                                    ...
                                    @endif
                                    @if($order->shipping > 0)
                                        <span class="me-1">+ Shipping: ₹{{ number_format($order->shipping, 2) }}</span>
                                    @endif
                                </div>
                                @endif
                            </td>
                            <td>
                                <div class="actions d-flex justify-content-center">
                                    ...
                                    <a href="#" class="btn btn-outline-success" title="Invoice" disabled>
                                        <i class="fas fa-file-invoice"></i>
                                    </a>
                                    @if($order->status == 'processing')
                                        <a href="#" class="btn btn-outline-info" disabled title="Ship order (not implemented)">
                                            <i class="fas fa-shipping-fast"></i>
                                        </a>
                                    @endif
                                    @if(in_array($order->status, ['pending', 'processing']))
                                        <a href="#" class="btn btn-outline-danger" disabled title="Cancel order (not implemented)">
