...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('admin.products-management.subcategories') }}" class="btn btn-secondary">Back</a>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.subcategories.update', $subcategory) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('admin.products-management.subcategories') }}" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
